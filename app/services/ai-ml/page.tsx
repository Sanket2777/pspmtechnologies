...
export default function AIMLPage() {
  ...
  return (
    <>
      {/* SEO */}
      <Head>
        <title>AI & Machine Learning Solutions | Intelligent Business Automation</title>
        <meta
          name="description"
          content="Advanced AI and Machine Learning solutions to automate processes, deliver predictive insights, and transform business operations with intelligent systems."
        />
        <meta
          name="keywords"
          content="AI Solutions, Machine Learning Services, Artificial Intelligence, AI Chatbots, Predictive Analytics, Business Automation"
        />

        {/* Open Graph */}
        <meta property="og:title" content="AI & Machine Learning Solutions" />
        <meta
          property="og:description"
          content="Scalable AI and Machine Learning services for automation, analytics, and intelligent decision-making."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://images.unsplash.com/photo-1677442136019-21780ecad995"
        />
      </Head>
